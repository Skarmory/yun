...
struct Race races[] =
{
    ...
    RACE('e', "night elf", "night elven", "Darnassus", "High Priestess Whisperwind", RA_NELF, FA_ALLIANCE, STATUPS(1, 2, 1, 0, 1)),
    ...
    RACE('l', "troll", "troll", "Orgrimmar", "Darkspear Leader Vol'jin", RA_TROLL, FA_HORDE, STATUPS(1, 2, 0, 1, 1))
};
